...
![sap rfc](/src/assets/images/blog/SAP_RFC.png)
...
- **Security and access restrictions**
    ...
    - RFC users often have limited permissions, meaning some required data may be blocked.
...
We understand you are using the SAP library …
