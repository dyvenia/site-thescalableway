...
In the era of AI, UI-based tools face one more limitation: they miss out on most of the benefits of the advanced code generation capacity of modern LLMs (Large Language Models)[[1](https://thescalableway-admin.netlify.app/blog/dlt-and-prefect-a-great-combo-for-streamlined-data-ingestion-pipelines/#1)].
...
To maintain trust with data platform users, make sure that when production pipelines fail, you are informed immediately and can recover quickly. While we recommend [implementing alerting in the orchestration layer](https://thescalableway-admin.netlify.app/blog/dlt-and-prefect-a-great-combo-for-streamlined-data-ingestion-pipelines/TODO), pipeline recoverability depends on having access to detailed logs.
